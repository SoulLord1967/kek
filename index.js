...
client.login("ODUxMDc0ODAxODUzMjY3OTc4.YLy_LA.b2-gqDY1XapVjGA7AyN_SDtGyvI");
const prefix = "st!";
//Düzenlenecek tek kısım diğer kodlara ellemeyiniz.\\

client.on("ready", () => console.log("SoulTube, AKTİF!"));//Bot aktif olunca, konsola yazılcak mesaj. Tırnak içindeki yazıyı değiştirebilirsiniz.
